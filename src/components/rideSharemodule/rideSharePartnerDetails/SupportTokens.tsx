            ...
            <Table responsive className='mb-0'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>#SB3456789008</td>
                        <td>Payout Issue</td>
                        <td>Miscalculation to the <span className='d-block'>payout check</span></td>
                        <td>Finance</td>
                        <td>
                        ...
                        <td>#SB3456789008</td>
                        <td>27-03-2025 at <span className='d-block'> 02:00 PM</span></td>
                    ...
                    <tr>
                        ...
                        <td>---</td>
                        <td>27-03-2025 at <span className='d-block'> 02:00 PM</span></td>
                        <td><span className="green-text green-btn">Closed</span></td>
                        <td>27-03-2025 at <span className='d-block'> 02:00 PM</span></td>
                        <td>Action</td>
                    </tr>
                    <tr>
                        ...
                        <td>#SB3456789008</td>
                        <td>27-03-2025 at <span className='d-block'> 02:00 PM</span></td>
                        <td><span className="blue-text grey-btn">Un-Assigned</span></td>
                        <td>---</td>
                        <td>Action</td>
                    </tr>
                    <tr>
                        ...
                        <td>#SB3456789008</td>
                        <td>Booking Issue</td>
                        <td>Booking Cancelled <span className='d-block'>Automatically</span></td>
                        <td>Support</td>
                        <td>
                            <Link href="" className='text-img-box d-flex align-items gap-2'>
                                <div className='table-img '>
                        ...
                        <td>---</td>
                        <td>27-03-2025 at <span className='d-block'> 02:00 PM</span></td>
                        <td><span className="red-text red-btn">Open</span></td>
                        <td>---</td>
                        <td>Action</td>
                    </tr>
                    <tr>
