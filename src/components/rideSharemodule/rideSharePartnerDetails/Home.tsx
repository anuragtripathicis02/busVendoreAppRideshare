...
import RideSharePartnerDetails from './RideSharePartnerDetails';
import TopProfileDetails from './TopProfileDetails';
// import RideShareAddPartners from './RideShareAddPartners';
...
const Home = () => {
  return (
    <div className='dashboard-details'>
        ...
        <div className='top-profile-details mt-2'>
            <TopProfileDetails />
        </div>
        <div className='ride-tabs-sec mt-xl-5 mt-3'>
            <RideSharePartnerDetails />
        </div>
        <Footer />
    </div>
  )
