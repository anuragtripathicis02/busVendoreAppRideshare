...
import ScooterImg from '../../../../public/images/scooter.png'
                ...
                <Table responsive className='mb-0'>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <Link href="" className='text-img-box d-flex align-items-center gap-2'>
                                    ...
                                    <div className='table-text text-start'>
                                        <h6 className='fw-normal'>SQUCH Normal</h6>
                                    </div>
                                </Link>
                            ...
                            <td>27-03-2025</td>
                            <td><span className='green-text green-btn'>Added</span></td>
                            <td>Action</td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>27-03-2025</td>
                            <td><span className='green-text purple-btn'>ADD</span></td>
                            <td>Action</td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <Link href="" className='text-img-box d-flex align-items-center gap-2'>
                                    <div className='table-img '>
                                        <Image src={ScooterImg} alt=''></Image>
                                    </div>
                                    <div className='table-text text-start'>
                                        <h6 className='fw-normal'>SQUCH Normal</h6>
                                    </div>
