...
const RideTutorialsModal = ({ show, handleClose }: { show: boolean; handleClose: () => void }) => {
  return (
                ...
                <div className='row'>
                    <div className='col-md-12 mb-4'>
                        <div className="form-group">
                            <Form.Label htmlFor="text1">Title</Form.Label>
                            <Form.Control type="text" id="text1" aria-describedby="" placeholder='Write here' />
                        </div>
                    </div>
                    <div className='col-md-12 mb-4'>
                        <div className="form-group">
                            <Form.Label htmlFor="text2">Video URL</Form.Label>
                            <Form.Control type="text" id="text2" aria-describedby="" placeholder='https://youtube.com/..' />
                        </div>
                    </div>
                    <div className='col-md-12 mb-4'>
                        <div className="form-group">
...
export default RideTutorialsModal