...
import RouteDetailsTop from './RouteDetailsTop';
import RouteDetailsBottom from './RouteDetailsBottom';
            ...
            <div className='page-details d-flex align-items-center gap-2'>
                ...
                <div className='left-details-heading'>
                    ...
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item active>Route Details</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
            </div>
          </div>
        <div className='vehicle-sec mt-4 '>
            <div className='vehicle-details-sec mb-4'>
              <RouteDetailsTop />
            </div>
