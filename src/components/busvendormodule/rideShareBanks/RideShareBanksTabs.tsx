            ...
            <Table responsive className='mb-0'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td  className='text-start'> Société Générale</td>
                        <td>12562</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Natixis</td>
                        <td>50</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>HSBC</td>
                        <td>100</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Citibank</td>
                        <td>200</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Calyon</td>
                        <td>200</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>BNP Paribas</td>
                        <td>200</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'> Banque Capitale Du Benin</td>
                        <td>200</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'> Arab Banking Corporation</td>
                        <td>200</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
                    ...
                    <tr>
                        ...
                        <td className='text-start'> Arab Bank</td>
                        <td>200</td>
                        <td><span className="green-text green-btn">Active</span></td>
                        <td>27-03-2025</td>
                        <td>Action</td>
...
export default RideShareBanksTabs